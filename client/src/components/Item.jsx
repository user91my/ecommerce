...
const Item = ({ item, width }) => {
  ...
  //      [ {…}, {…}, {…}, {…}, {…}, ... ]
  // Each 'item' object (in "items" array) will look like the following :-
  //      {
  ...
  // Extract the 'formats' object by destructuring the 'image' object.
  const {
    data: {
      attributes: { formats },
    },
  ...
  // Optional chaining (?.) applied on 'medium' and 'small' properties to ensure they exist.
  // If 'formats.medium' is 'undefined' or 'null', the nullish coalescing operator (??) provides
  // a fallback value (on the right), that is 'formats.small'.
