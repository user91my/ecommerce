...
const stripePromise = loadStripe(
  "pk_test_51OKy0ZFxzD6fbJ2f953tKhE46UlpYry1jiWzoX13ZQhG4k2KuvHOnBeK8TBzY9QdEqeqUkYhgLkEC6rnNkDFOdXR007FbR2kvG"
);
...
const Checkout = () => {
  ...
  const makePayment = async (values) => {
    ...
    const requestBody = {
      ...
      email: values.email,
      // "cart.map()" returns an array of objects each only containing 'id' and 'count' keys.
    ...
    // The response (from the backend; see "server\src\api\order\controllers\order.js")
