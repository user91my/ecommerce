        ...
        <Box padding="30px" overflow="auto" height="100%">
          ...
          <Box>
            {cart.map((item) => {
              ...
              // Optional chaining is applied on each nested property (image, data, attributes, etc.)
              // to ensure that every one exists. If any one property returns 'undefined' or 'null',
              // the expression short circuits and evaluates to 'undefined' instead of throwing an error.
              // The nullish coalescing operator provides a fallback value (on the right), that is an empty
              // object.
              const formats =
